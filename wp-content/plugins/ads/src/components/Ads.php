...
class Ads extends Component{
    ...
    public function UpdateAdGroups($campaignId, $adGroupId,$name, $updateAudienceAdsBidAdjustment=false, $returnInheritedBidStrategyTypes=true)
    {

        $request = new UpdateAdGroupsRequest();
        $request->CampaignId = $campaignId;
        $adGroups=[
            ['Id'=>$adGroupId, "Name"=>$name]];
        $request->AdGroups = $adGroups;
    ...
    public function GetAdGroupsByCampaignId($campaignId, $returnAdditionalFields=[]){
        $request = new GetAdGroupsByCampaignIdRequest();
        $request->CampaignId = $campaignId;
        $request->ReturnAdditionalFields = $returnAdditionalFields;
        return $this->campaignManagementProxy->GetService()->GetAdGroupsByCampaignId($request);
    }
