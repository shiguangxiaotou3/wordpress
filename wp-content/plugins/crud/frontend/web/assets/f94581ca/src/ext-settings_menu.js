...
var optionGroups = {
    Main: {
        ...
        "字体大小": {
            ...
            defaults: [
                ...
                { caption: "36px", value: 36 },
                { caption: "48px", value: 48 },
            ]
        },
        "软包装": {
            type: "buttonBar",
            path: "wrap",
            items: [
                { caption: "关闭", value: "off" },
                { caption: "视图", value: "free" },
                { caption: "边缘", value: "printMargin" },
                { caption: "40", value: "40" }
            ]
        },
        "光标样式": {
        ...
        "折叠": {
            path: "foldStyle",
            items: [
                { caption: "手动", value: "manual" },
                { caption: "标记开始", value: "markbegin" },
                { caption: "标记开始和结束", value: "markbeginend" }
            ]
        },
        "软标签": [{
                path: "useSoftTabs"
            }, {
                ariaLabel: "选项卡大小Tab Size",
                path: "tabSize",
                type: "number",
                values: [2, 3, 4, 8, 16]
            }],
    ...
    More: {
        ...
        "合并撤消增量": {
            ...
            items: [
                { caption: "总是", value: "always" },
                { caption: "从不", value: "false" },
                { caption: "定时", value: "true" }
            ]
        },
        "弹性制表符": {
