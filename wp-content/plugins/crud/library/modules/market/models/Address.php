...
class Address extends \yii\db\ActiveRecord
{
    ...
    public function columns(){
        return [
            ...
            ['field' => 'created_at', 'title' => Yii::t('market', 'Created At'),"formatter"=>'datetime',"style"=>'width: 100px'],
            ['field' => 'updated_at', 'title' => Yii::t('market', 'Updated At'),"formatter"=>'datetime',"style"=>'width: 100px'],
        ];
    }
}
