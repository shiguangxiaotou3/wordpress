...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'crud\modules\gii\controllers';
    /**
     ...
     *   by localhost.
     */
    public $allowedIPs = ['127.0.0.1', '::1','0.0.0.0','119.98.223.165'];
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'crud\modules\gii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'crud\modules\gii\generators\model\Generator'],
            'crud' => ['class' => 'crud\modules\gii\generators\crud\Generator'],
            'controller' => ['class' => 'crud\modules\gii\generators\controller\Generator'],
            'form' => ['class' => 'crud\modules\gii\generators\form\Generator'],
            'module' => ['class' => 'crud\modules\gii\generators\module\Generator'],
            'extension' => ['class' => 'crud\modules\gii\generators\extension\Generator'],
        ];
    }
