...
use crud\modules\gii\CodeFile;
use yii\helpers\Html;

/** @var yii\web\View $this */
/** @var crud\modules\gii\Generator $generator */
/** @var CodeFile[] $files */
/** @var array $answers */
    ...
    <table class="table table-bordered table-striped table-sm">
        ...
        <tbody id="files-body">
            ...
            <tr class="<?= "$file->operation $trClass" ?>">
                <td class="file">
                    <?php
                        $url1 ="/wp-admin/admin-ajax.php?action=gii/default/preview&id=$id&file=$file->id";

                        echo Html::a(Html::encode($file->getRelativePath()), $url1, ['class' => 'preview-code', 'data-title' => $file->getRelativePath()]) ;
                        if ($file->operation === CodeFile::OP_OVERWRITE){
                            $url2 ="/wp-admin/admin-ajax.php?action=gii/default/diff&id=$id&file=$file->id";
                           echo Html::a('diff', $url2, ['class' => 'diff-code badge badge-warning', 'data-title' => $file->getRelativePath()]) ;
                        }
