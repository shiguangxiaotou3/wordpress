...
namespace crud\modules\crud\generators\controller;
...
class Generator extends BaseGenerator
{
    ...
    {
        return Yii::t('console', 'Controller Generator');
    }
    ...
    {
        return Yii::t('console', 'This generator helps you to quickly generate a new controller class with one or several controller actions and their corresponding views.');
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            ['controllerClass', 'match', 'pattern' => '/^[\w\\\\]*Controller$/', 'message' => Yii::t('console','Only word characters and backslashes are allowed, and the class name must end with "Controller".')],
            ['controllerClass', 'validateNewClass'],
            ['baseClass', 'match', 'pattern' => '/^[\w\\\\]*$/', 'message' =>   Yii::t('console','Only word characters and backslashes are allowed.')],
            ['actions', 'match', 'pattern' => '/^[a-z][a-z0-9\\-,\\s]*$/', 'message' =>  Yii::t('console','Only a-z, 0-9, dashes (-), spaces and commas are allowed.')],
            ['viewPath', 'safe'],
        ]);
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'actions' => Yii::t('console', 'Action IDs'),
        ];
    }
    ...
    {
        return Yii::t('console', 'The controller has been generated successfully.') . $this->getLinkToTry();
    }
    ...
    private function getLinkToTry()
    {
        ...
        return Yii::t('console',' You may ') . Html::a(Yii::t('console','try it now'), Yii::$app->getUrlManager()->createUrl($route), ['target' => '_blank', 'rel' => 'noopener noreferrer']) . '.';
    }
