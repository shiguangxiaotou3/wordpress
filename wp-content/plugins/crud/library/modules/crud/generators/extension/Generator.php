...
namespace crud\modules\crud\generators\extension;
...
class Generator extends BaseGenerator
{
    ...
    {
        return Yii::t('console','Extension Generator');
    }
    ...
    {
        return Yii::t('console','This generator helps you to generate the files needed by a Yii extension.');
    }
        ...
        return array_merge(
            ...
            [
                ...
                [
                    ...
                    'match',
                    'pattern' => '/^[a-z0-9\-\.]+$/',
                    'message' => Yii::t('console','Only lowercase word characters, dashes and dots are allowed.')
                ],
                [
                    ['namespace'],
                    'match',
                    'pattern' => '/^[a-zA-Z0-9_\\\]+\\\$/',
                    'message' =>  Yii::t('console','Only letters, numbers, underscores and backslashes are allowed. PSR-4 namespaces must end with a namespace separator.')
                ],
            ]
        );
    }
    ...
    {
        return [
            'vendorName'  =>  Yii::t('console','Vendor Name'),
            'packageName' => Yii::t('console', 'Package Name'),
            'license'     =>  Yii::t('console','License'),
        ];
    }
    ...
    {
        return [
            'vendorName'  => Yii::t('console','This refers to the name of the publisher, your GitHub user name is usually a good choice, eg. <code>myself</code>.'),
            'packageName' => Yii::t('console','This is the name of the extension on packagist, eg. <code>yii2-foobar</code>.'),
            'namespace'   => Yii::t('console','PSR-4, eg. <code>myself\foobar\</code> This will be added to your autoloading by composer. Do not use yii, yii2 or yiisoft in the namespace.'),
            'keywords'    => Yii::t('console','Comma separated keywords for this extension.'),
            'outputPath'  => Yii::t('console','The temporary location of the generated files.'),
            'title'       => Yii::t('console','A more descriptive name of your application for the README file.'),
            'description' => Yii::t('console','A sentence or subline describing the main purpose of the extension.'),
        ];
    }
