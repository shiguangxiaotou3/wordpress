...
/** @var crud\modules\crud\Generator[] $generators */
/** @var crud\modules\crud\Generator $activeGenerator */
/** @var string $content */

$generators = Yii::$app->controller->module->generators;
$activeGenerator = Yii::$app->controller->generator;
?>
<?php $this->beginContent('@library/modules/crud/views/layouts/main.php'); ?>
<div class="row">
