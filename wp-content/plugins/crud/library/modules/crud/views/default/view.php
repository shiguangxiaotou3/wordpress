        ...
        <div class="row">
            <div class="col-lg-8 col-md-10" id="form-fields">
                ...
                <?= $form->field($generator, 'template')
                    ->sticky()
                    ->hint(Yii::t('console','Please select which set of the templates should be used to generated the code.'))
                    ->label(Yii::t('console','Code Template'))
                    ->dropDownList($templates) ?>
                <div class="form-group">
                    <?= Html::submitButton(Yii::t('console','Preview'), ['name' => 'preview', 'class' => 'btn btn-primary']) ?>

                    <?php if (isset($files)): ?>
                        <?= Html::submitButton(Yii::t('console','Generate'), ['name' => 'generate', 'class' => 'btn btn-success']) ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
