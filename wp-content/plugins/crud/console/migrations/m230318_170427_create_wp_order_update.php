...
/**
 * Class m230318_170427_create_wp_order_update
 */
class m230318_170427_create_wp_order_update extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        echo "m230318_170427_create_wp_order_update cannot be reverted.\n";
...
//        $this->dropTable('{{%order}}');
        ...
        $this->createTable('{{%order}}', [
            ...
            'receipt_amount'=>$this->decimal(8,2)->notNull()->comment('实收金额'),
            "trade_no"=>$this->string(255)->notNull()->comment('支付流水号'),
            'notify_number'=>$this->string(255)->notNull()->comment('通知次数'),
