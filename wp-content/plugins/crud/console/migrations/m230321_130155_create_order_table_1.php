...
/**
 * Class m230321_130155_create_order_table_1
 */
class m230321_130155_create_order_table_1 extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        echo "m230321_130155_create_order_table_1 cannot be reverted.\n";
    ...
    public function up()
    {
        ...
        $this->createTable('{{%order}}', [
            'id' => $this->primaryKey(),
            'pal_type'=>$this->string(10)->notNull()->comment('支付场景'),
