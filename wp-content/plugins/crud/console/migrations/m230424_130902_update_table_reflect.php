...
/**
 * Class m230424_130902_update_table_reflect
 */
class m230424_130902_update_table_reflect extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    public function up()
    {
        ...
        $this->createTable('{{%pay_reflect}}', [
            ...
            'pay_type'=>$this->string()->defaultValue(null)->comment('提现渠道'),
            'account'=>$this->string()->notNull()->comment('收款账号'),
            'account_name'=>$this->string()->notNull()->comment('用户名'),
            'money'=>$this->float(6,2)->notNull()->comment('金额'),
